        ...
        <div className="about-flex">
          <div className="about-content">
            ...
            <p>
              ...
              العقارية لأكثر من 20 عاما. تشمل مستشارين عقاريين وفنين بالإضافة
              إلى فريق محاسبة، ويعتبر فريق العمل متكاملا لدراسة العقار ومقارنته
              بالسوق، وتحديد مدى الدخل المتوقع وتقييم فرص زيادة دخل العقار
              والتحسينات المطلوبة، مع توافير فريق صيانة لتقليل التكاليف،
              بالإضافة إلى وجود برامج متخصصة لإدارة الوحدات العقارية تناسب
              احتياجات العميل, حيث تهدف مؤسسة غايات لإدارة الأملاك لأعلى عائد
              لملاك العقارات وحصول المستأجرين أفضل منتج.
            </p>
          </div>
          <div className="about-list">
            <div className="list-item">
              ...
              <p>
                تتمتع المؤسسة بخبرة ومعرفة تراكمية متخصصة في مجال إدارة الأملاك
                العقارية لأكثر من 20 عام. كما انه لدى المؤسسة فريق عمل متكامل
                لدراسة العقار ومقارنته بالسوق، وتحديد مدى الدخل المتوقع وتقييم
                فرص زيادة دخل العقار والتحسينات المطلوبة، مع إمكانية توفير فريق
                صيانه، بالأضافة إلي إدارة الوحداة العقارية التأجير لفترات تناسب
                العميل.
              </p>
            </div>
            <div className="list-item">
            ...
            <div className="list-item">
              ...
              <p>
                ...
                لكلا الطرفين (مؤجرين و مستأجرين) لتحقيق التشغيل الأمثل لعقارك مع
                النوعية المرغوبة من المستأجرين، لمحاولة بناء علاقة مستدامة.
              </p>
            </div>
            <div className="list-item">
              <IconAbout04 />
              ...
              <p>
                تهدف مؤسسة غايات لإدارة الأملاك لأعلى عائد لملاك العقارات وحصول
                المستأجرين علي أفضل منتج.
              </p>
            </div>
          </div>
        </div>
